...
<section class="bg-white overflow-hidden z-10">
   <div class="container"> 
   <div class="flex flex-wrap w-full mb-20">
          <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
            <h1 class="sm:text-5xl text-2xl font-bold title-font mb-2 text-gray-900">Contact</h1>
            <div class="h-1 w-20 bg-indigo-500 rounded"></div>
            <h2>Nous serions ravie de Répondre a vos préoccupations</h2>
          </div>
        </div>
      <div class="flex flex-wrap lg:justify-between ">
         <div class="w-full lg:w-1/2 xl:w-6/12 ">
            <div class="max-w-[570px] mb-12 lg:mb-0">
               ...
               <p class="text-base text-gray-900 font-semibold leading-relaxed mb-9 text-justify">
                  Selons vos exigences vous pouvez nous laisses un Message via notre
                  adresse email tout en indiquant votre préoccupation ou nous appeles
                  via notre contact
               </p>
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-dark text-xl mb-1">Localisation</h4>
                     <p class="text-base text-body-color">
                        99 En sienne sonel Mimbo-Man 28292. Yaoundé
                     </p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     <h4 class="font-bold text-dark text-xl mb-1">Télephone</h4>
                     <p class="text-base text-body-color">(+237) 696 96 96 95</p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full">
                  <div
         ...
         <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
            <div class="bg-white rounded-lg p-8 sm:p-12 shadow-lg">
               <form>
                  <div class="mb-6">
                     <input
                        type="text"
