...
<div class="flex justify-center items-center w-full bg-blue-400">
    <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
        <h1 class="block w-full text-center text-blue-600 text-2xl font-bold mb-6">Annonce de recherche</h1>
        <form action="/" method="post">
            ...
            <div class="flex flex-col mb-4">
                <label class="mb-2 font-bold text-lg text-gray-900" for="Date">Date de perte du document</label>
            ...
            <div class="flex flex-col mb-4">
                <label class="mb-2 font-bold text-lg text-gray-900" for="textarea">Dans quelles condition l'avez-vous égaré</label>
            ...
            <div class="flex flex-col mb-4">
                <label class="mb-2 font-bold text-lg text-gray-900" for="remuneration">Shouaité-vous laisse une remunération pour celui qui trouve votre doc?</label>
                <input class="border border-gray-300 py-2 px-3 text-grey-800" type="text" name="remuneration" id="remuneration"/>
            </div>
